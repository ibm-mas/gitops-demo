...
- Create the following secrets in AWS Secrets Manager:
  ...
  - `<account>/<cluster>/aws`: the access token and secret token for AWS Secrets Manager, which is used by various ArgoCD sync hooks to make updates to secrets
...
# Substitute the values below with your own
ICR_USERNAME="xxx"
ICR_PASSWORD="xxx"
