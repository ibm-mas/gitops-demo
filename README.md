...
Some of the templates in the chart are capable of generating multiple Applications that install a Helm chart on the target cluster. This is used when there may be one or more instances of the particular resources being configured, and thus may vary between MAS instances - for instance DB2 databases, suite configs, and suite/application workspaces. 
